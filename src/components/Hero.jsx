...
const Hero = () => {
  return (
    <main className='flex lg:mt-20 flex-col lg:flex-row items-center justify-between min-h-[calc(90vh-6rem)]'>
      ...
      <img src="/sushi.png" alt="" className='absolute lg:top-0 top-[-20%] bottom-0 lg:left-[50%] sm:left-[-2%] h-full' />
      {/* <Spline
        className='absolute lg:top-0 top-[-20%] bottom-0 lg:left-[25%] sm:left-[-2%] h-full'
        scene="https://prod.spline.design/Ey3IOdmZ94xGLwg2/scene.splinecode"
      /> */}
    </main>
  );
};
