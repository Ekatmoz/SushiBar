...
const Footer = () => {
  return (
    <footer
        className=" fadeInUp dark:bg-gray-dark relative z-10 pt-16 md:pt-20 lg:pt-24"
        data-wow-delay=".1s"
      >
        <div className="container">
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">© Copyright Sushi Bar Hungary. All Rights Reserved</p>
