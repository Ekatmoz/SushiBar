export const translations = {
  en: {
    ...
    workshopPage: {
      title: 'Sushi Workshop in Siófok',
      badge: 'Gift of an unforgettable experience',
      description: 'Surprise someone you love – or even yourself – with a special culinary experience where exciting new flavors, an inspiring atmosphere, and Japanese culture come together!',
      paragraph1: 'During our sushi-making workshop in Siófok, you’ll get an introduction to the exciting world of Japanese cuisine while learning to make delicious maki rolls and nigiri with your own hands. Our professional Sushi Chefs will be by your side throughout the workshop, so even complete beginners can join with confidence!',
      subtitle1: 'Workshop program',
      features: [
        'Welcome drink: honey wine infused with ginger and black rice',
        'A brief introduction to Japanese culture and cuisine',
        'Preparation of several types of maki and nigiri',
        'Ongoing professional guidance from experienced Sushi Chefs',
        'Authentic sake tasting',
        'Useful sushi tips, tricks, and plating techniques',
        'Take your handmade sushi home – surprise your family or friends with sushi made by you!',
        'Complimentary Sushi Kit and certificate',
        'A friendly, intimate atmosphere with just 10–15 participants per workshop',
        'At the end of the workshop, you can also purchase ingredients at a discounted price',
      ],
      paragraph2: 'Workshop duration: approximately 2 hours.',
      button: 'Buy Tickets / Register',
      paragraph3: 'We provide all the necessary ingredients, equipment, and an apron – all you need to do is focus on enjoying the experience and having a great time!',
    },
    footer: {
